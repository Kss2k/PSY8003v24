...
```{stata}
reg flat_price i.location
margins, at(location = (1 2))
marginsplot
```

![](images/Skjermbilde%202023-06-27%20120825.png){width="622"}
...
PLS_model <- csem(.data = na.omit(workout), .model = model,
                  .resample_method = "bootstrap", .R = 200)

PLS_model_mediation <- rmedsem(PLS_model, 
        indep = "Attract", 
        med = "Appear", 
        dep = "Calories",
        approach = c("bk", "zlc")) 
